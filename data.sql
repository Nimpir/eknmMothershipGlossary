...
INSERT OR IGNORE INTO "contents" VALUES(51,'🪖',NULL,NULL,NULL,'{"die": "d10", "entries": [{"min": 0, "max": 0, "text": "Tank Top and Camo Pants (AP 1), Combat Knife (as Scalpel DMG [+]), Stimpak (x5)", "links": [{"id": 16, "label": "Scalpel"}, {"id": 98, "label": "Stimpak"}]}, {"min": 1, "max": 1, "text": "Advanced Battle Dress (AP 10), Flamethrower (4 shots), Boarding Axe", "links": [{"id": 45, "label": "Advanced Battle Dress"}, {"id": 5, "label": "Flamethrower"}, {"id": 2, "label": "Boarding Axe"}]}, {"min": 2, "max": 2, "text": "Standard Battle Dress (AP 7), Combat Shotgun (4 rounds), Rucksack, Camping Gear", "links": [{"id": 44, "label": "Standard Battle Dress"}, {"id": 3, "label": "Combat Shotgun"}, {"id": 93, "label": "Rucksack"}]}, {"min": 3, "max": 3, "text": "Standard Battle Dress (AP 7), Pulse Rifle (3 mags), Infrared Goggles", "links": [{"id": 44, "label": "Standard Battle Dress"}, {"id": 13, "label": "Pulse Rifle"}, {"id": 74, "label": "Infrared Goggles"}]}, {"min": 4, "max": 4, "text": "Standard Battle Dress (AP 7), Smart Rifle (3 mags), Binoculars, Personal Locator", "links": [{"id": 44, "label": "Standard Battle Dress"}, {"id": 17, "label": "Smart Rifle"}, {"id": 60, "label": "Binoculars"}, {"id": 86, "label": "Personal Locator"}]}, {"min": 5, "max": 5, "text": "Standard Battle Dress (AP 7), SMG (3 mags), MRE (x7)", "links": [{"id": 44, "label": "Standard Battle Dress"}, {"id": 18, "label": "SMG"}, {"id": 81, "label": "MRE (x7)"}]}, {"min": 6, "max": 6, "text": "Fatigues (AP 2), Combat Shotgun (2 rounds), Dog (pet), Leash, Tennis Ball", "links": [{"id": 3, "label": "Combat Shotgun"}, {"id": 87, "label": "Pet (Organic)"}]}, {"min": 7, "max": 7, "text": "Fatigues (AP 2), Revolver (12 rounds), Frag Grenade", "links": [{"id": 14, "label": "Revolver"}, {"id": 8, "label": "Frag Grenade"}]}, {"min": 8, "max": 8, "text": "Dress Uniform (AP 1), Revolver (1 round), Challenge Coin", "links": [{"id": 14, "label": "Revolver"}]}, {"min": 9, "max": 9, "text": "Advanced Battle Dress (AP 10), General-Purpose Machine Gun (1 can of ammo), HUD", "links": [{"id": 45, "label": "Advanced Battle Dress"}, {"id": 9, "label": "General-Purpose Machine Gun"}, {"id": 73, "label": "Heads-Up Display (HUD)"}]}]}','psg',7,51);
INSERT OR IGNORE INTO "contents" VALUES(52,'🤖',NULL,NULL,NULL,'{"die": "d10", "entries": [{"min": 0, "max": 0, "text": "Vaccsuit (AP 3), Smart Rifle (2 mags), Infrared Goggles, Mylar Blanket", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 17, "label": "Smart Rifle"}, {"id": 74, "label": "Infrared Goggles"}, {"id": 82, "label": "Mylar Blanket"}]}, {"min": 1, "max": 1, "text": "Vaccsuit (AP 3), Revolver (12 rounds), Long-range Comms, Satchel", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 14, "label": "Revolver"}, {"id": 77, "label": "Long-range Comms"}]}, {"min": 2, "max": 2, "text": "Hazard Suit (AP 5), Revolver (6 rounds), Defibrillator, First Aid Kit, Flashlight", "links": [{"id": 43, "label": "Hazard Suit"}, {"id": 14, "label": "Revolver"}, {"id": 69, "label": "First Aid Kit"}, {"id": 70, "label": "Flashlight"}]}, {"min": 3, "max": 3, "text": "Hazard Suit (AP 5), Foam Gun (2 charges), Sample Collection Kit, Screwdriver (as Assorted Tools)", "links": [{"id": 43, "label": "Hazard Suit"}, {"id": 7, "label": "Foam Gun"}, {"id": 95, "label": "Sample Collection Kit"}, {"id": 57, "label": "Assorted Tools"}]}, {"min": 4, "max": 4, "text": "Standard Battle Dress (AP 7), Tranq Pistol (3 shots), Paracord (100m)", "links": [{"id": 44, "label": "Standard Battle Dress"}, {"id": 20, "label": "Tranq Pistol"}, {"id": 84, "label": "Paracord (50m)"}]}, {"min": 5, "max": 5, "text": "Standard Crew Attire (AP 1), Stun Baton, Small Pet (organic)", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 19, "label": "Stun Baton"}, {"id": 87, "label": "Pet (Organic)"}]}, {"min": 6, "max": 6, "text": "Standard Crew Attire (AP 1), Scalpel, Bioscanner", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 16, "label": "Scalpel"}, {"id": 61, "label": "Bioscanner"}]}, {"min": 7, "max": 7, "text": "Standard Crew Attire (AP 1), Frag Grenade, Pen Knife", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 8, "label": "Frag Grenade"}]}, {"min": 8, "max": 8, "text": "Manufacturer Supplied Attire (AP 1), Jump-9 Ticket (destination blank)"}, {"min": 9, "max": 9, "text": "Corporate Attire (AP 1), VIP Corporate Key Card"}]}','psg',7,52);
INSERT OR IGNORE INTO "contents" VALUES(53,'🔬',NULL,NULL,NULL,'{"die": "d10", "entries": [{"min": 0, "max": 0, "text": "Hazard Suit (AP 5), Tranq Pistol (3 shots), Bioscanner, Sample Collection Kit", "links": [{"id": 43, "label": "Hazard Suit"}, {"id": 20, "label": "Tranq Pistol"}, {"id": 61, "label": "Bioscanner"}, {"id": 95, "label": "Sample Collection Kit"}]}, {"min": 1, "max": 1, "text": "Hazard Suit (AP 5), Flamethrower (1 charge), Stimpak, Electronic Tool Set", "links": [{"id": 43, "label": "Hazard Suit"}, {"id": 5, "label": "Flamethrower"}, {"id": 98, "label": "Stimpak"}, {"id": 65, "label": "Electronic Tool Set"}]}, {"min": 2, "max": 2, "text": "Vaccsuit (AP 3), Rigging Gun, Sample Collection Kit, Flashlight, Lab Rat (pet)", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 15, "label": "Rigging Gun"}, {"id": 95, "label": "Sample Collection Kit"}, {"id": 70, "label": "Flashlight"}, {"id": 87, "label": "Pet (Organic)"}]}, {"min": 3, "max": 3, "text": "Vaccsuit (AP 3), Foam Gun (2 charges), Foldable Stretcher, First Aid Kit, Radiation Pills (x5)", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 7, "label": "Foam Gun"}, {"id": 71, "label": "Foldable Stretcher"}, {"id": 69, "label": "First Aid Kit"}, {"id": 90, "label": "Radiation Pills (x5)"}]}, {"min": 4, "max": 4, "text": "Lab Coat (AP 1), Screwdriver (as Assorted Tools), Medscanner, Vaccine (1 dose)", "links": [{"id": 57, "label": "Assorted Tools"}, {"id": 79, "label": "Medscanner"}]}, {"min": 5, "max": 5, "text": "Lab Coat (AP 1), Cybernetic Diagnostic Scanner, Portable Computer Terminal", "links": [{"id": 64, "label": "Cybernetic Diagnostic Scanner"}, {"id": 89, "label": "Portable Computer Terminal"}]}, {"min": 6, "max": 6, "text": "Scrubs (AP 1), Scalpel, Automed (x5), Oxygen Tank with Filter Mask", "links": [{"id": 16, "label": "Scalpel"}, {"id": 58, "label": "Automed (x5)"}, {"id": 83, "label": "Oxygen Tank"}]}, {"min": 7, "max": 7, "text": "Scrubs (AP 1), Vial of Acid, Mylar Blanket, First Aid Kit", "links": [{"id": 82, "label": "Mylar Blanket"}, {"id": 69, "label": "First Aid Kit"}]}, {"min": 8, "max": 8, "text": "Standard Crew Attire (AP 1), Utility Knife (as Scalpel), Cybernetic Diagnostic Scanner, Duct Tape", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 16, "label": "Scalpel"}, {"id": 64, "label": "Cybernetic Diagnostic Scanner"}]}, {"min": 9, "max": 9, "text": "Civilian Clothes (AP 1), Briefcase, Prescription Pad, Fountain Pen (Poison Injector)"}]}','psg',7,53);
INSERT OR IGNORE INTO "contents" VALUES(54,'🔧',NULL,NULL,NULL,'{"die": "d10", "entries": [{"min": 0, "max": 0, "text": "Vaccsuit (AP 3), Laser Cutter (1 extra battery), Patch Kit (x3), Toolbelt with Assorted Tools", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 11, "label": "Laser Cutter"}, {"id": 85, "label": "Patch Kit (x3)"}, {"id": 57, "label": "Assorted Tools"}]}, {"min": 1, "max": 1, "text": "Vaccsuit (AP 3), Revolver (6 rounds), Crowbar, Flashlight", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 14, "label": "Revolver"}, {"id": 4, "label": "Crowbar"}, {"id": 70, "label": "Flashlight"}]}, {"min": 2, "max": 2, "text": "Vaccsuit (AP 3), Rigging Gun (1 shot), Shovel, Salvage Drone", "links": [{"id": 42, "label": "Vaccsuit"}, {"id": 15, "label": "Rigging Gun"}, {"id": 94, "label": "Salvage Drone"}]}, {"min": 3, "max": 3, "text": "Hazard Suit (AP 5), Vibechete, Spanner, Camping Gear, Water Filtration Device", "links": [{"id": 43, "label": "Hazard Suit"}, {"id": 22, "label": "Vibechete"}, {"id": 99, "label": "Water Filtration Device"}]}, {"min": 4, "max": 4, "text": "Heavy Duty Work Clothes (AP 2), Explosives & Detonator, Cigarettes", "links": [{"id": 68, "label": "Explosives & Detonator"}]}, {"min": 5, "max": 5, "text": "Heavy Duty Work Clothes (AP 2), Drill (as Assorted Tools), Paracord (100m), Salvage Drone", "links": [{"id": 57, "label": "Assorted Tools"}, {"id": 84, "label": "Paracord (50m)"}, {"id": 94, "label": "Salvage Drone"}]}, {"min": 6, "max": 6, "text": "Standard Crew Attire (AP 1), Combat Shotgun (4 rounds), Extension Cord (20m), Cat (pet)", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 3, "label": "Combat Shotgun"}, {"id": 87, "label": "Pet (Organic)"}]}, {"min": 7, "max": 7, "text": "Standard Crew Attire (AP 1), Nail Gun (32 rounds), Head Lamp, Toolbelt with Assorted Tools, Lunch Box", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 12, "label": "Nail Gun"}, {"id": 57, "label": "Assorted Tools"}]}, {"min": 8, "max": 8, "text": "Standard Crew Attire (AP 1), Flare Gun (2 rounds), Water Filtration Device, Personal Locator, Subsurface Scanner", "links": [{"id": 41, "label": "Standard Crew Attire"}, {"id": 6, "label": "Flare Gun"}, {"id": 99, "label": "Water Filtration Device"}, {"id": 86, "label": "Personal Locator"}]}, {"min": 9, "max": 9, "text": "Lounge Wear (AP 1), Crowbar, Stimpak, Six Pack of Beer", "links": [{"id": 4, "label": "Crowbar"}, {"id": 98, "label": "Stimpak"}]}]}','psg',7,54);
